...
SFX_F:
    ...
    .byte 0,  2,  2,  2,  4,  6,  8,  8,  8,  8,  8,  8,  8,  8,  8,  8 ; ping
    ;.byte 0, 31, 31, 31, 31, 31, 31, 21, 21, 21, 31, 31, 31, 31, 31, 31 ; game over
    .byte 0, 31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20, 16, 12, 8
    .byte 0, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21
    .byte 0
    REPEAT 13
    .byte 12
    REPEND
...
SFX_CV:
    .byte 0,$84 ; collide
sfxCOLLIDE = *-SFX_CV-1
    .byte 0,$62,$6f,$6f,$6f,$6f,$6f,$6f,$6f,$6f,$6f,$6f,$6f; collect
sfxCOLLECT = *-SFX_CV-1
    .byte 0,$4e,$42,$43,$44,$45,$46,$47,$48,$49,$4a,$4b,$4c,$4d,$4e,$4f ; ping
sfxPING = *-SFX_CV-1
